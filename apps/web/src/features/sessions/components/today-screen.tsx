...
import { formatDate, shortDuration } from "@/lib/format";
import { t } from "@/lib/i18n";
import { useCoachMutation, useDay, useOwnCoachMembership } from "../hooks/use-coach";
import { useOutcomes } from "../hooks/use-outcomes";
import { withQueued } from "../outcome-queue";
import { completeFollowUp, type DaySession, type Outcome } from "../queries/coach";
import { addDays, cairoToday, isIsoDate } from "../week";

...
import { coachKeys, recordAttendance, type CoachDay, type Outcome } from "../queries/coach";
 ...
 * - No signal → the tap is queued (localStorage) and replayed when the phone is back online, every 15 s, and on the next open.

...
import { configurePlatform, memoryPlatform } from "../../platform";

// the in-memory platform stands in for IndexedDB / AsyncStorage, so the queue logic runs anywhere
...
describe("offline outbox", () => {
  beforeEach(() => configurePlatform(memoryPlatform()));
